/**
 * Cookie Blocker - Click handler for cookie consent buttons
...
;(function () {
  ...
  function _sl(selector, container, allMatches) {
    if (selector.startsWith('//') || selector.startsWith('(//')) return _ev(selector, false, true)
      ...
      for (let i = 0; i < host.long.length; i++) {
        switch (host.long[i]) {
          ...
          case 'continental':
            return _if_else(
              '.js-cookie-banner',
              ['.is-cookiebanner-visible .ci-cookie-link', '.is-settings-view .js-cookie-accept'],
          ...
          case 'fiveguys':
            ...
            return e && _ev("*[contains(., 'cookie')] | *[contains(., 'Cookie')]", e)
          ...
          case 'iobroker':
            return _ev('div[./div/p[text()="This website uses cookies"]]//button')
          case 'itella':
          ...
          case 'doppelherz':
            return _sl('.bg-coolgray')
              ...
              : _sl('.cookie-inquiry-wrapper.show .cookie-inquiry--configuration .button')
          ...
          case 'dafy-moto':
            return _if('.js-popup-init .icon-cookies', '.js-popup-init a[class*="close"]')
          case 'aviasales':
          ...
          case 'easyname':
            return _chain('.overlay--cookie-modal .choose-settings', '.choose-settings:first-child')
          case 'lyst':
            return _chain(
          ...
          case 'mediamarkt':
          case 'saturn':
            if (host.full == 'outlet.mediamarkt.nl') return '.force--consent.show--consent #s-sv-bn'
    ...
    switch (host.full) {
      ...
      case 'web.de':
        return _if_else(
          ...
          ['.window-on #save-all-pur'],
          ['.window-on #edit-purpose-settings', '#save-purpose-settings', '#confirm-reject'],
        )
      ...
      case 'nastygal.com':
        return _if_else(
          ...
          ['.privacy-policy.visible .button-more-info', '.js-reject-options-button:not(.disabled)'],
        )
      ...
      case 'tumblr.com':
        ...
        if (e) {
          const e2 = _sl(
            '.cmp__dialog-footer-buttons button.is-secondary:not(.' + classname + ')',
      ...
      case 'tomtom.com':
        e = _id('themeFooter')
        return e && e.shadowRoot
          ? _sl('.cookie-panel:not(.zd_Hidden) #cookie_panel_accept_all', e.shadowRoot)
          : false
      ...
      case 'so.energy': {
        e = _sl('app-footer')
        const button =
          e && e.shadowRoot ? _sl('.cookie-banner button.is-secondary', e.shadowRoot) : false
        if (button) button.click()
      ...
      case 'ideal.lv':
        return _if('.overlayopen', '//button[.//span[contains(text(), "atlasītajiem sīkfailiem")]]')
      case 'ideal.ee':
        return _if('.overlayopen', '//button[.//span[contains(text(), "valitud küpsistega")]]')
      ...
      case 'ironhack.com':
        return _if('.chakra-slide p[class*="CookieBanner"]', '.chakra-slide button:first-child')
      ...
      case 'sevdesk.de':
        return _chain('.cookie-link', '.cookie-banner__container_button > div:first-child button')
      case 'my.sevdesk.de':
        return '.cookie-consent-modal[style*="block"] .btn[ng-click*="secondarySaveAction"]'
      case 'sevdesk.at':
        return _chain('.cookie-link', '.cookie-banner__container_button > button:first-child')
      ...
      case 'swedbank.com':
        return _chain('#cookie-banner-initial-customize', '#cookie-banner-customize-customize')
      ...
      case 'wannonce.com':
        return _if('.jconfirm-open a[onclick*="goToPrivacy"]', '.jconfirm-open .btn')
      case 'paard.nl':
        return _chain(
      ...
      case 'id.nl':
        return _if('#__next > .fixed a[href*="privacy"]', '#__next > .fixed button')
      ...
      case 'leo.org':
        return _if('.show-modal a[href*="privacy"]', '.show-modal ion-card + ion-card ion-button')
      case 'weremember.com':
      ...
      case 'fredolsen.es':
        return _chain('.modal[style*="block"] ~ div #reject-cookies', '.save-cookies')
      case 'emailoctopus.com':
        return _chain('#cookie-consent-modal.active #manage-preferences', '#save-preferences')
      case 'tmarket.bg':
      ...
      case 'yourstorebox.com':
        return _chain('.cookie-active .react-cookie-law-manage-btn', '.react-cookie-law-save-btn')
      case 'ticketfritz.de':
      ...
      case 'vamox.io':
        return _if('.v-dialog--active a[href*="cookies"]', '.v-dialog--active .error')
      case 'dext.com':
        return _chain(
      ...
      case 'obenaufs.com':
        return _if('.vol-modal.fade-in a[href*="ID=265"]', '.vol-modal.fade-in .close-modal')
      case 'ionity.eu':
        return _chain('#external-cookies', '#gdpr-cc-btn-save')
      case 'lynkco.com':
        return _chain('.modal-mask .reject button', '.cookie-setting + .button-group button')
      case 'sakret.de':
      ...
      case 'scaleway.com':
        return _if('#modal a[href*="cookie-policy"]', '#modal button + div button:first-child')
      ...
      case 'readly.com':
        return _if_else(
          ...
          ['.cookie-option-large > div:last-child', '.CookieConsentOption ~ button'],
        )
      case 'evium.de':
      ...
      case 'healthygamer.gg':
        return _if('.swal2-show a[href*="privacy-policy"]', '.swal2-show .swal2-cancel')
      ...
      case 'garten-und-freizeit.de':
        return _chain('.cook-modal .settings-button', '.cook-modal .actions > button')
      case 'nexera.pl':
      ...
      case 'billiger.de':
        return _if('#cookie-banner-overlay', '.open-cookie-options', '#cookie-options .accept')
      case 'bestjobs.eu':
        return _if(
      ...
      case 'nestbank.pl':
        return _if('.MuiDialog-root', '//div[@role="presentation"]//button[contains(., "Zamknij")]')
      case 'u-bordeaux.fr':
      ...
      case 'ezil.me':
        return _if('#portal > div a[href*="Terms_of_Operation"]', '#portal > div > button')
      ...
      case 'talktalk.co.uk':
        return _chain('.cookie__manage', '#togBtnPersonal', '#togBtnRemarket', '#saveSetting')
      ...
      case 'continental-jobs.com':
        return _chain('.modal[style*="block"] .cwt-btn-link', '.js-cookie-accept')
      case 'trading212.com':
        return _chain(
      ...
      case 'studio.benq.com':
        return _chain('.modal[style*="block"] #cbx-cookies-optional', '#btn-accept-cookies')
      case 'mironet.cz':
      ...
      case 'energetyka24.com':
        return _if('.modal.show a[href*="polityka-prywatnosci"]', '.modal.show .btn')
      case 'dfwairport.com':
      ...
      case 'lekarna-bella.cz':
        return _chain('.modal[style*="block"] .cookie-settings-set', '.cookie-confirm')
      ...
      case 'trenes.com':
        return _if('.fancybox-overlay[style*="block"] #popCookies', '#popCookies2 .rechazar')
      case 'vulco.es':
      ...
      case 'elcorteingles.es':
        return _chain('.c-modal[style*="block"] .js-cookies__trigger', '.js-cookies__accept')
      case 'hansapark.de':
      ...
      case 'audisto.com':
        return _chain('.vam-dialog-shown #vam-dialog a[href="#details"]', '.vam-btn-configure')
      case 'halleysac.it':
      ...
      case 'starjack.at':
        return _if('.MuiDialog-root h4[id*="cookie"]', '.MuiDialog-root button:first-child')
      ...
      case 'pathe-thuis.nl':
        return _if('.modal__dialog', '//button[text()="Nee, ik wil alleen minimale cookies"]')
      case 'vaillant.de':
      ...
      case 'czc.cz':
        return _chain('#ccp-popup[style*="block"] .js-settings', '.ccp-controls__submit-settings')
      case 'warszawa.pl':
      ...
      case 'nseguros.pt':
        return _if('#cookies-flow-container', 'FLAG:UNIQUE', '.manage-cookies', '.manage-cookies')
      case 'zusammen.de':
      ...
      case 'carbonify.eu':
        return _if('#popup:not([style*="none"])', '//div[@id="popup"]//button[text()="Ablehnen"]')
      case 'defence24.pl':
      ...
      case 'rocrivor.nl':
        return _if('#cookiewall[style*="block"]', '#id_third_party_cookies_1', '#cookiewall button')
      case 'pizzafan.gr':
      ...
      case 'configure.bmw.ca':
        return _sl(
          ...
          _sl('con-overlay-cookies', _sl('con-overlay-logic', _sl('con-app').shadowRoot).shadowRoot)
            .shadowRoot,
        )
      case 'bosch-diy.com':
      ...
      case 'napster.com':
        return _if('.info_box[style*="block"] a[href*="cookies"]', '.info_box .close')
      case 'hunqz.com':
        return _if(
      ...
      case 'caseking.de':
        return _chain('.consent-modal #settings-button', '.consent-modal #save-button')
      case 'wgv.de':
      ...
      case 'investify.com':
        return _if('.MuiDialog-root', '//button[contains(., "Nur ausgewählte Cookies übernehmen")]')
      ...
      case 'bitbrain.com':
        return _sl('.eu-cookie-compliance-banner-wrapper[style*="block"] .accept-cookies')
      case 'e-shelter.de':
      ...
      case 'frisco.pl':
        return _chain('.cookies-consents_actions .secondary', '.cookies-consents_actions .comfort')
      case 'ecoplus.at':
      ...
      case 'max-academy.de':
        return _if('.MuiDialog-root a[href*="privacy"]', '.MuiDialog-root button + button')
      ...
      case 'draeger.com':
        return _chain('.cookie-consent .settings', '.cookie-consent .button.secondary')
      case '2ip.io':
        return _chain(
      ...
      case 'mydpd.at':
        return _chain('#cookieModal[style*="block"] #cookies_settings', '#cookies_settings')
      case 'smule.com':
        return _chain('//button[text()="Manage Cookies"]', '//button[text()="Confirm My Choices"]')
      case 'gibgas.de':
      ...
      case '2ip.ru':
        return _chain('.notice__container__settings', '#app-item-googleAnalytics', '.cm-btn-accept')
      case 'handyhuellen.de':
        return _chain('#consent a[href*="preferences"]', '#consent a[href*="save"]')
      case 'sex.com':
      ...
      case 'extract.pics':
        return _if('.fixed a[href*="privacy"]', '//button[./span[text()="Accept selected"]]')
      case 'modepark.de':
        return _if(
          '.vex',
      ...
      case 'ima.it':
        return _chain('#cookieBanner[style*="block"] .showPrefs', '.acceptCookie')
      case 'statik.be':
      ...
      case 'hl.co.uk':
        return _chain('.-cb-open #AOCookieToggle', '#TPCookieToggle', '#updateCookieButton')
      case 'liveagent.com':
      ...
      case 'robinhood.com':
        return _if('#__next > div:last-child a[href*="privacy"]', '#__next > div:last-child button')
      ...
      case 'polsatgo.pl':
        return _ev('span[contains(text(), "Nie, przejdź do serwisu")]/parent::node()')
      case 'autohero.com':
        return _chain(
      ...
      case 'mol.hu':
        return _chain('#modalCookie.is-visible .btn + .btn', '#modalCookie button:only-of-type')
      case 'benq.eu':
      ...
      case 'pu.nl':
        return _if('div[class*="dialog_box"] a[href*="privacy"]', 'div[class*="dialog_box"] button')
      case 'valdemarne.fr':
        return _chain(
      ...
      case 'teikeicoffee.org':
        return _sl('#ar-cookie-modal[style*="block"] .btn[onclick*="confirm_selection"]')
      case 'boschbad.nl':
      ...
      case 'euplf.eu':
        return _chain('#cookieConsentSettingsBtn', '#cookieConsentSettingsSaveBtn')
      ...
      case 'login.nos.pt':
        return _sl('#cookiebanner[style*="block"] .btn[onclick*="acceptLevelPreferences"]')
      case 'thsrc.com.tw':
      ...
      case 'oead.at':
        return _sl('#cookie-notice[style*="block"] a[data-dismiss]:not([data-allowall])')
      case 'vermieterverein.de':
        return _sl('.dialog-area:not([style*="none"]) .btn-info[onclick*="cookie_loader"]')
      ...
      case 'ikarus.de':
        return _sl('#amgdpr-cookie-block:not([style*="none"]) .amgdpr-button--secondary')
      ...
      case 'ikbenfrits.nl':
        return _if('.ant-modal-root a[href*="cookiestatement"]', '.ant-modal-root .btn.green')
      case 'diefabrik-sundern.de':
        return _if('#POPUPS_ROOT a[href*="datenschutz"]', '#POPUPS_ROOT div[role="button"]')
      ...
      case 'zoom.nl':
        return _if('div[class*="dialog-cookie-consent"]', 'div[class*="dialog_box"] button')
      ...
      case 'idagio.com':
        return _sl('.ReactModal__Overlay--after-open [class*="consent-manager"] button:first-child')
      case 'lansberg.de':
      ...
      case 'mcdelivery.de':
        return _sl('.optanon-alert-box-wrapper:not([style*="none"]) .accept-cookies-button')
      ...
      case 'mein-wohndesign24.de':
        return _sl('.v-dialog__content--active .ui-cookie-consent button.primary')
      case 'vorteile.net':
      ...
      case 'latam.com':
        return _sl('.cookie-terms-overlay:not([class*="closed"]) .cookie-terms-modal__button')
      ...
      case 'stoxenergy.com':
        return _sl('#___gatsby div[class*="ConsentManagerDisplay"] button + button')
      case 'penny.at':
      ...
      case 'ebonline.be':
        return _sl('.modal[aria-labelledby*="cookie-warning"][style*="block"] .btn-primary')
      case 'camping.info':
        return _sl('.v--modal-overlay[data-modal="CiCookieLayer"] .order-2 + .order-2')
      ...
      case 'droptica.com':
        return _sl('.d-gtm-scripts-modal-wrapper--is-open #d-gtm-scripts-save-settings')
      case 'pelix-media.de':
      ...
      case 'teutoburger-muenzauktion.de':
        return _sl('.reveal-overlay[style*="block"] #phila-cookie-modal .button.clear')
      case 'noodweer.be':
      ...
      case 'tredy-fashion.de':
        return _sl('.ui-dialog[style*="block"] #cookieFlyout button[onclick*="submit"]')
      ...
      case 'argutus.de':
        return _sl('#ag-consentmanager-wrapper[style*="block"] #btn-consent-save')
      case 'sport2000.fr':
      ...
      case 'wienenergie.at':
        return _sl('.__reakit-portal [class*="CookieConsent-module__actions"] button')
      case 'amzpecty.com':
      ...
      case 'oventrop.com':
        return _sl('.modal[style*="block"] #ConsentModalControl_lbtnSaveSelection')
      case 'thincast.com':
        return _sl('.uk-open #AcceptCookies')
      case 'truste.com':
        return _sl('.pdynamicbutton .call, #gwt-debug-close_id')
      case 'pronovabkk.de':
        return _sl('.reveal[style*="block"] button[data-accept-cookie-disclaimer]')
      case 'osehero.pl':
      ...
      case 'norddeutsch-gesund.de':
        return _sl('#consent_manager:not([style*="none"]) #consent_settings_save_button')
      case 'mitgas.de':
      ...
      case 'hot.si':
        return _sl('.bootbox.modal[style*="block"] .btn[data-bb-handler="allow"]')
      ...
      case 'wanted.law':
        return _sl('.cdk-overlay-container .dtx-cookie-voorkeuren-modal-buttons .btn')
      case 'tipser.com':
      ...
      case 'ktr.com':
        return _sl('.modal[style*="block"] .btn[onclick*="setCookieBannerAccepted"]')
      case 'itaa.be':
      ...
      case 'juitnow.com':
        return _sl('.modal[style*="block"] .btn[data-cy="cookies-save-settings"]')
      ...
      case 'foxtons.co.uk':
        return _sl('.fancybox-overlay[style*="block"] .cookie_option[data-choice*="Yes"]')
      case 'ilmarinen.fi':
      ...
      case 'aarsfjv.dk':
        return _sl('dff-cookie-consent-dialog button[data-cookiescanner*="accept"]')
      case 'langeland.nl':
      ...
      case 'prosa.dk':
        return _sl('.t3cms-cookies-overlay:not([style*="none"]) .t3cms-cookies-select-all')
      ...
      case 'hemdenbox.de':
        return _sl('#s-cookie-consent[style*="block"] #s-cookie-consent-accept-all')
      case 'sendgb.com':
        return _sl('.cookie_checker[style*="block"] ~ .sendgb_cookiewarning .cookiebutton')
      case 'realm667.com':
      ...
      case 'lbbw.de':
        return _sl('.component-data-protection-consent.show .action-save-settings')
      case 'deka.de':
      ...
      case 'shpock.com':
        return _sl('#__next ~ div[id*="modal"] div[class*="PrivacyConsent"] button')
      case 'indiearenabooth.com':
        return _sl('#cookie-consent:not([style*="none"]) #btn-cookie-consent-positive')
      ...
      case 'vodafone.nl':
        return _sl('.cookiewall___wrapper:not([style*="none"]) .cookiewall__accept')
      case 'strato.de':
        return _sl(
      ...
      case 'sunny.co.uk':
        return _sl('.cookie-acceptance-modal button[name="accept-cookies-button"]')
      case 'pacma.es':
        return _id('panel_cookies_todas')
      case 'impulse.de':
        return _sl('.button[data-cc-accept]')
      case 'dailyfx.com':
        return _sl('.dfx-cookiesNotification--visible .jsdfx-cookiesNotification__close')
      case 'cinkciarz.pl':
      ...
      case 'lebara.com':
        return _sl('#cookiesConsentModal[style*="block"] .btn[onclick*="accept"]')
      case 'malcoded.com':
      ...
      case 'norwegian.no':
        return _sl('nas-element-cookie-consent[style*="block"] .nas-button[class*="accept"]')
      case 'amewi.com':
      ...
      case 'tk.de':
        return _sl('.is-display-consentmanager .g-consentmanager__confirm-selection')
      case 'redbook.com.au':
      ...
      case 'coolmath.com':
        return _sl('.gdpr-overlay-container[style*="visible"] .accept-all-cookies')
      case 'm.bancopopular.com':
        return _sl('#popup-cookieinfo:not(.hide) #btn-dmp-continue')
      case 'stat.si':
        return _sl('.surs-cookies-wrapper[style*="block"] .surs-cookie-button-yes')
      ...
      case 'weather-gb.com':
        return _sl('#privacy_consent_Modal[style*="block"] .btn[onclick*="Save"]')
      ...
      case 'dokterdokter.nl':
        return _sl('.reveal-overlay[style*="block"] .button[name="acceptAllCookies"]')
      ...
      case 'guce.oath.com':
        return _sl('.consent-form .agree-button-group .btn, .consent-container .btn[name="agree"]')
      case 'pathe.nl':
      ...
      case 'deondernemer.nl':
        return _sl('.cookiewall #cookiewall .button, button[name="acceptCookies"]')
      case 'todopvr.com':
      ...
      case 'agar.io':
        return _sl('#cc-notification[style*="block"] .cc-approve-button-thissite-ads')
      case 'f1racing.pl':
      ...
      case 'consent.talpanetwork.com':
        return _sl('meer-accept-cookie-policy meer-button, .package-choice-page button')
      ...
      case 'lavalleedestortues.fr':
        return _sl('.reveal-overlay[style*="block"] #modalCookies .button[href*="accept"]')
      case 'smartshop.hu':
      ...
      case 'nieuwspoort.nl':
        return _sl('.reveal-overlay[style*="block"] #cookie-consent .button[href*="accept"]')
      case 'flybe.com':
      ...
      case 'forever21.com':
        return _sl('#cookiesPopup[style*="block"] button[onclick*="AcceptCookie"]')
      case 'hondanews.eu':
        return _sl(
      ...
      case 'bynco.com':
        return _chain('.cookie-info:first-child', '.cookie-accept-button:last-child')
      case 'walmart.ca':
      ...
      case 'axa-corporatesolutions.com':
        return _sl('.js-root > div > div > div > div > div > div > div > a:first-child + a')
      case 'gofundme.com':
      ...
      case 'fideliti.co.uk':
        return _sl('.ui-dialog[style*="block"] #ctl00_CookieControl1_AcceptCookieButton')
      case 'dellmont.com':
      ...
      case 'tiger.nl':
        return _sl('.reveal-overlay[style*="block"] #cookieMessage .ConsentButton')
      case 'cookieservice.aginsurance.be':
        return _sl('.ag-CookieConsentWrapper button[ng-click*="allowAllCookies"]')
      ...
      case 'saudia.com':
        return _sl('.ui--popup[style*="block"] .approve-website-cookies #travelContinue')
      case 'binance.je':
        return _sl('#__next > .layout > main ~ div a[href*="support.binance.je"] + div')
      ...
      case 'vinbanken.se':
        return _sl('.fancybox-overlay[style*="block"] .cookie-takeover-inner > a')
      ...
      case 'union.nl':
        return _sl('.c-cookie-bar[data-redirect] .cookie-bar__button[js-hook-cookies-accept]')
      case 'melcloud.com':
      ...
      case 'paradoxplaza.com':
        return _sl('#cookies-info:not(.cookie-info-disabled) .accept-cookie-policy')
      case 'yello.de':
        return _sl(
      ...
      case 'amministrazionicomunali.it':
        return _sl('#cp-container:not([style*="none"]) #cookie-policy-agree-onlynecessary a')
      case 'healthsoul.com':
      ...
      case 'hogrefe.de':
        return _sl('.fancybox-is-open #fancybox-cookie-consent-settings .set-setting')
      ...
      case 'parfuemerie.de':
        return _sl('.fancy-box-containerCookiemanager.fancybox-opened #accept-cookies-all')
      ...
      case 'energyavenue.com':
        return _sl('.fancybox-overlay[style*="block"] .green-btn[href*="acceptcookies"]')
      ...
      case 'lescommis.com':
        return _sl('.modal.in[aria-labelledby="confirm-modal-label"] .btn-default')
      case 'hasura.io':
        return _sl('#content > div > div > div > a[href*="privacy"] ~ img[alt*="Close"]')
      case 'tirerack.com':
        return _sl('.modalContainer[style*="block"] button[onclick*="acceptTerms"]')
      case 'itsnicethat.com':
        return _sl('.fixed > .bg-mineshaft button.bg-sun')
      case 'pewdiepie.store':
        return _sl('#gatsby-focus-wrapper div[class*="CookiesNotification"] button')
      case 'blackboard.com':
        return _sl('.CookieConsent #agree_button')
      case 'pointblankmusicschool.com':
        return _sl('.fancybox-overlay[style*="block"] .accept[onclick*="cookieControl"]')
      case 'werkenbijpathe.nl':
        return _sl('.cookie-notification__button:last-child')
      case 'kempen.com':
        return _sl('.cookie-bar--is-visible .button[data-js-hook="accept-button"]:not([disabled])')
      case 'wuestenrot.at':
      ...
      case 'klett.de':
        return _sl('.modal[style*="block"] footer[id*="cookie-consent"] .btn-primary')
      ...
      case 'opngo.com':
        return _sl('.cookie-banner-modal[style*="block"] .cookie-accept-all > div')
      ...
      case 'kivra.se':
        return _sl('#___gatsby div[class*="CookieSplash"] button[class*="accept"]')
      case 'skb.si':
      ...
      case 'omictools.com':
        return _sl('#cookie-policy-intro-dialog[style*="block"] .js-accept-all-intro')
      case 'vier-pfoten.de':
      ...
      case 'swietawdomu.pl':
        return _sl('#cf-root.cookiefirst-root button[data-cookiefirst-button="primary"]')
      case 'hanover.com':
      ...
      case 'dier-en-dokter.nl':
        return _chain('.consent-wrapper.show #js-cw-consents', '.cf-container.show #js-cw-update')
      case 'samsung.com':
        return _chain(
      ...
      case 'all3dp.com':
        return _if('.pur-root a[href*="cookie-policy"]', '.pur-root button:only-child')
      ...
      case 'nyiron.hu':
        return _if('.ZebraDialog', '//div[@class="ZebraDialog"]//a[contains(text(), "Cookie-kat")]')
      ...
      case 'arztnoe.at':
        return _chain('.cookie-settings__cookie.switch label', '.js-save-cookie-settings')
      case 'assos.com':
      ...
      case 'yachtall.com':
        return _chain('#cookie-consent-first .js-showConsentChoice', '.js-saveCookieConsent')
      case 'lastmile.lt':
        return _if('.chakra-link[href="/policy"]', '//div[./div/p/a[@href="/policy"]]//button')
      ...
      case 'reaguurder.gs':
        return _if('.approve-btn', '//button[@class="approve-btn"][contains(@title, "cookies")]')
      ...
      case 'bestcarbuyer.co.uk':
        return _chain('#nexus-cookie-popup .btn:last-child', '#nexus-cookie-policy-modal .btn')
      ...
      case 'hornet.com':
        return _if('.modal--active a[href*="privacy-policy"]', '.modal--active button:first-child')
      case 'sreal.at':
      ...
      case 'hydroscand.se':
        return _chain('.modal-popup._show .pr-cookie-setting-btn', '.modal-slide._show .decline')
      ...
      case 'crazypatterns.net':
        return _chain('.modal[style*="block"] .cookie-consent-extended', '#cookie-consent-apply')
      case 'lessonup.com':
        return '.cookie-popup-modal .accept-all'
      case 'peddler.com':
        return _if('.has-cookie-banner', '#app > div > div > p + div > button:last-child')
      case 'norli.no':
        return _chain(
      ...
      case 'ejobs.ro':
        return _chain('.CookiesPopup__ModifyButton', '.CVsSharedModalsAddEdit__ModifyCookies')
      case 'datagrottan.se':
      ...
      case 'konectis.com':
        return _if('.o-map-popup a[href*="advanced-tracking"]', '.o-map-popup button:first-child')
      ...
      case 'craftelier.com':
        return _chain('.modal-popup._show .pr-cookie-setting-btn', '.modal-popup._show .decline')
      case 'herbal-store.cz':
        return '.focus-cookiebara.active .btn[data-cookie-bar="custom"]:first-child'
      case 'qdq.com':
        return _chain('.cookieControl__Button--outlined', '.cookieControl__ModalSaveButton')
      case 'edeka.de':
      ...
      case 'marshall.com':
        return _chain('.modal[style*="block"] #ManageCookiesButton', '#AcceptSelectedCookiesButton')
      case 'mydhlfreight.com':
        return '.MuiDialog-root button[data-tracking*="cookie-disclaimer"]'
      case 'depo.ee':
        return _if('div.fixed', '//div[contains(@class, "fixed")]//button[*="Nõustun kõigiga"]')
      case 'tesco.hu':
      ...
      case 'kempten.de':
        return _chain('#consentModal[style*="block"] #consentCookiesCB', '#consentModalBtn')
      ...
      case 'pubg.com':
        return _chain('.cookie-modal .base-button--cancel', '.cookie-modal .base-button--confirm')
      case 'turnier.de':
        return _if(
      ...
      case 'folders.nl':
        return _if('.v-dialog--active a[href*="privacy"]', '.v-dialog--active button:last-child')
      case 'picockpit.com':
        return _if_else(
          '#vue',
          [
      ...
      case 'vogelsbergkreis.de':
        return _chain('.cookie-consent-form__reject-button', '.cookie-consent-form__save-button')
      case 'yougov.com':
