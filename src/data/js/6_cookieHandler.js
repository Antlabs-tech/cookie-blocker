...
function getE(hostname) {
  switch (hostname) {
    ...
    case 'bosch-climate.be':
      return ['BoschTTBECookieConsent=%7B%22comfort%22%3Atrue%2C%22marketing%22%3Afalse%7D'] // webbooking
    ...
    case 'tv-trwam.pl':
      return ['HAS_COOKIES_FORM_SHOWED=true', 'ARE_REQUIRED_COOKIES_ACCEPTED=true']
    case 'phish-test.de':
      return ['gtag=true']
    case 'sea-seek.com':
      return ['OK_Cook=OK']
    ...
    case 'theathletic.com':
      return ['cookie-policy-accept=0', 'cookie-policy-optout=analyticaltracking']
    case 'kayak.co.uk':
    ...
    case 'scaleway.com':
      return ['consent-advertising=false', 'consent-analytics=false', 'consent-marketing=false']
    ...
    case 'svt.se':
      return ['cookie-consent-1={"optedIn":true,"functionality":false,"statistics":false}']
    case 'ertflix.gr':
      return [
    ...
    case 'stevensbikes.de':
      return ['stv_cconsent_statistics=0', 'stv_cconsent_external=0', 'stv_cconsent_required=1']
    ...
    case 'cinobo.com':
      return ['cb_functionality=denied', 'cb_performance=denied', 'cb_necessary=granted']
    ...
    case 'gemeinde-schipkau.de':
      return ['cookieconsent=technical', 'cookieconsentTimestamp=9999999999999']
    case 'tibber.com':
      return [
    ...
    case 'tradingview.com':
      return ['cookiesSettings-consent={"analytics":false,"advertising":false}']
    case 'sj.se':
      return [
    ...
    case 'eau.veolia.fr':
      return ['hasConsent=value%3Drequired-only%3BcreationDate%3D9762385041866']
    case 'hellowatt.fr':
    ...
    // EXTRA COOKIE HANDLER of combined open PRs
    case 'laserdelux.pl':
      return [
