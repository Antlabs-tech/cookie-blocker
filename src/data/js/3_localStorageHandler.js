/**
 * Cookie Blocker - Local storage handler for cookie consent blocking
  ...
  switch (hostname) {
    ...
    case 'blaetterkatalog.welt.de':
      return {
        strict: true,
        key: 'DM_prefs',
        value: '{"cookie_hint":true,"accept_cookies":false,"_childs":[],"_type":1}',
      }
    ...
    case 'erli.pl':
      return {
        ...
        value: '{"marketingAndStatistics":false,"personalization":false,"at":99999999999999}',
      }
    case 'ranobelib.me':
      return {
        strict: false,
    ...
    case 'teilauto.net':
      return {
        ...
        value: '{"configId":1,"pageId":1,"version":1,"saved":1762026743,"cookies":[]}',
      }
    case 'app.filen.io':
      return {
        strict: true,
    ...
    case 'extra.ge':
      return {
        ...
        value: 'Thu Nov 06 2077 00:00:00 GMT+0100 (Central European Standard Time)',
      }
    case 'timeweb.cloud':
      return {
        strict: false,
